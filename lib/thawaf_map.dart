...
class ThawafMap extends StatefulWidget {
  @override
  _ThawafMapState createState() => _ThawafMapState();
}

class _ThawafMapState extends State<ThawafMap> {
  ...
  final List<LatLng> _polygonCoords = [
    LatLng(21.4225, 39.8262), // [0] Pusat
    LatLng(21.424048, 39.826513), // [1] yamani / utara
    LatLng(21.422894, 39.824397), // [2] syami / barat
    LatLng(21.420937, 39.825784), // [3] iraqi / selatan
    LatLng(21.421998, 39.827817), // [4] hajar aswad / timur
  ];
              ...
              polygons: [
                Polygon(
                  points: [
                    ...
                    LatLng(21.424048, 39.826513),
                    LatLng(21.422894, 39.824397),
                  ],
