...
class KoniGooglePage extends StatefulWidget {
  @override
  _KoniGooglePageState createState() => _KoniGooglePageState();
}

class _KoniGooglePageState extends State<KoniGooglePage> {
  ...
  int _determineQuadrant(LatLng position) {
    ...
    if (_isPointInPolygon(position, [
      LatLng(-7.279148, 112.779938), //sudut
      LatLng(-7.279131, 112.779513), //barat
      LatLng(-7.279955, 112.779925), //selatan
    ])) {
      return 1;
    } else if (_isPointInPolygon(position, [
      LatLng(-7.279148, 112.779938), //sudut
      LatLng(-7.279955, 112.779925), //selatan
      LatLng(-7.279155, 112.780347), //timur
    ])) {
      return 2;
    } else if (_isPointInPolygon(position, [
      LatLng(-7.279148, 112.779938), //sudut
      LatLng(-7.279155, 112.780347), //timur
      LatLng(-7.278345, 112.779947), //utara
    ])) {
      return 3;
    } else if (_isPointInPolygon(position, [
      LatLng(-7.279148, 112.779938), //sudut
      ...
      body: Stack(
        children: [
          FlutterMap(
            ...
            options: MapOptions(
              center: currentPosition ?? LatLng(-7.279148, 112.779938),
              zoom: 18.0,
            ),
            children: [
              TileLayer(
                ...
                polygons: [
                  ...
                  Polygon(
                    points: [
                      LatLng(-7.279148, 112.779938), //sudut
                      LatLng(-7.278345, 112.779947), //utara
                      LatLng(-7.279131, 112.779513), //bara
                    ],
