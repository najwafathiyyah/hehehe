...
class rumahcuaupdate extends StatefulWidget {
  @override
  _rumahcuaupdateState createState() => _rumahcuaupdateState();
}

class _rumahcuaupdateState extends State<rumahcuaupdate> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        FlutterMap(
          options: MapOptions(
            center: LatLng(-7.330520, 112.747260),
            zoom: 17,
          ),
          children: [
            TileLayer(
